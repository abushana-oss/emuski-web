-- Fix all ambiguous column references in credit functions

-- Fix reserve_credits function
...
-- Fix cleanup_credit_reservations function
CREATE OR REPLACE FUNCTION cleanup_credit_reservations()
RETURNS VOID
LANGUAGE plpgsql
AS $$
BEGIN
