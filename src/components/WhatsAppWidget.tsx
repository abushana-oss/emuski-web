...
const WhatsAppWidget: React.FC<WhatsAppWidgetProps> = ({ 
  ...
  return (
    <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-whatsapp-widget flex flex-col items-end gap-4 pointer-events-none" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
