...
export const metadata: Metadata = {
  title: 'EMUSKI - Premier OEM Manufacturing & Precision Engineering Solutions in Bangalore, India',
  description: 'EMUSKI delivers world-class OEM manufacturing, precision engineering, CNC machining, injection molding, and AI-powered production systems. ISO 9001:2015 certified with 15+ years of excellence serving 75+ global clients across automotive, aerospace, and medical device industries.',
  keywords: [
    'OEM manufacturing Bangalore',
    'precision engineering India',
    'CNC machining services',
    'injection molding Bangalore',
    'manufacturing solutions India',
  ...
  openGraph: {
    ...
    title: 'EMUSKI - Premier OEM Manufacturing & Precision Engineering Solutions',
    description: 'ISO 9001:2015 certified OEM manufacturing with 15+ years excellence. Serving 75+ global clients across automotive, aerospace, and medical device industries with precision engineering and AI-powered production.',
    images: [
      {
        url: 'https://www.emuski.com/og-image.jpg',
        secureUrl: 'https://www.emuski.com/og-image.jpg',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    site: '@emuski',
    creator: '@emuski',
    title: 'EMUSKI - Premier OEM Manufacturing Solutions',
    description: 'ISO 9001:2015 certified with 15+ years excellence. Precision engineering, CNC machining, and AI-powered production in Bangalore, India.',
    images: [
      {
        url: 'https://www.emuski.com/twitter-image.jpg',
...
export default function Home() {
  ...
  const localBusinessSchema = {
    ...
    name: 'EMUSKI Manufacturing Solutions',
    image: 'https://www.emuski.com/og-image.jpg',
    telephone: '+91-86670-88060',
    email: 'enquiries@emuski.com',
    address: {
      '@type': 'PostalAddress',
